...
export const packet: LearningPacket = {
  nodeId: "l2-matrices",
  whyNow:
    "A matrix is a machine that moves space. Every neural layer and robot pose you will touch is one. By the end you will look at a matrix and see the actual transformation it performs on space.",
  diagnostic: {
    prompt:
  ...
  coreWatch: [
    {
      ...
      minutes: 11,
      whySelected: "The key video of the group. Columns are where the basis vectors land, and seeing that clears up the misconception at the heart of this node.",
    ...
    },
    {
      ...
      minutes: 10,
      whySelected: "Shows why order matters. AB means do B first, and that comes straight from the geometry.",
    ...
    },
    {
      ...
      minutes: 10,
      whySelected: "det as the signed area scale, and det = 0 as space getting flattened so information is lost.",
  ...
  coreRead: [
    {
      ...
      minutes: 75,
      whySelected: "Light on proofs, full of exercises. It puts what the videos showed into formal terms.",
    },
  ],
  practice: [
    ...
    { prompt: "VMLS exercises for §6/§10/§11: at least 6 problems, on paper, with answers checked in NumPy.", source: "https://vmls-book.stanford.edu/vmls.pdf", minutes: 45 },
  ],
  implement: {
  ...
  transfer: {
    task: "A robot camera reports a detection at (0.4, 0.8) in a frame rotated 30° from base. Using only what this node built, write the matrix that converts camera coordinates to base coordinates and apply it. (No lookup; work out the direction of the rotation yourself.)",
